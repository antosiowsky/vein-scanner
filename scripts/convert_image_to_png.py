...
def get_augmentation_pipeline():
    ...
    return A.Compose([
        ...
        # Zastąpiono przestarzałe ShiftScaleRotate nowym Affine
        A.Affine(
            translate_percent={"x": (-0.06, 0.06), "y": (-0.06, 0.06)},
            scale=(0.85, 1.15), # scale_limit=0.15 -> scale od 1-0.15 do 1+0.15
            rotate=0,
            p=0.8,
            cval=0, # Wypełnienie dla obrazu
            cval_mask=0 # Wypełnienie dla maski
        ),
        
        # Poprawiony argument: 'variance_limit'
...
def augment_and_save_data():
    ...
    """
    print("--- Rozpoczynam proces augmentacji (dla czystych danych 1:1) ---")
